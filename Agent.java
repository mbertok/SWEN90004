...
public class Agent {
	 ...
	 *            - the color of the agent
	 * @param potential
	 *            - the potential to reproduce of the agent
	 * @param same
	 *            - whether the agent cooperates with same color
	 * @param diff
	 *            - whether the agent cooperates with different colors
	 */
	 ...
	 *            - the amount to give
	 * @param a
	 *            - the agent to give the amount to
	 */
	 ...
	 * 
	 * @param cost
	 *            - the cost of interaction for an agent
	 * @param gain
	 *            - the gain by an interaction to an agent
	 * @param a
	 ...
	 * 
	 * @param prob
	 *            - the probabilty to check against
	 ...
	 * 
	 * @param death_rate
	 *            - the death rate to check against
	 * @return - true if an agent can die and false otherwise
	 */
	public boolean canDie(double death_rate) {
	 ...
	 * 
	 * @param mut_rate
	 *            - the mutation rate of the agent
	 * @param ptr
	 *            - the potential to reproduce of an agent
	 * @param min_col
	 *            - the minimum color
	 * @param max_col
	 *            - the maximum color
