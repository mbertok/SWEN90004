...
public class Agent {
    ...
    {
    	String sameFlag = this.coop_same? "C":"D";
    	String diffFlag = this.coop_diff? "C":"D";
        System.out.println(sameFlag);
        System.out.println(diffFlag);
        return (sameFlag+diffFlag+"-"+String.valueOf(ptr));
        //return(sameFlag+diffFlag+"-"+String.format("%0.2f", String.valueOf(ptr)));
    }
